...
class Foreclosure(OperationStat):
    ...
    court_name = models.CharField(max_length=255, null=True, blank=True, verbose_name='Court Name')
    case_type = models.CharField(max_length=255, null=True, blank=True, verbose_name='Case Type')
