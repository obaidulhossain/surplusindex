...
def availableLeads(request):
    ...
    surplusStatusND = params.get('status_nd', '').lower()
    surplusStatusPS = params.get('status_ps', '').lower()
    surplusStatusNPS = params.get('status_nps', '').lower()
    surplusStatusFA = params.get('status_fa', '').lower()
    surplusStatusMF = params.get('status_mf', '').lower()
    surplusStatusFC = params.get('status_fc', '').lower()
    surplusStatusNS = params.get('status_ns', '').lower()
    saleStatusACTIVE = params.get('sale_status_active', '').lower()
    saleStatusSOLD = params.get('sale_status_sold', '').lower()
    saleStatusCANCELED = params.get('sale_status_canceled', '').lower()
